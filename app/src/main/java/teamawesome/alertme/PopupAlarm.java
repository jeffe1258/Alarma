...
public class PopupAlarm extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (exceedsPrecipitationCondition) {
            dataRain.setText("Precipitacion: " + currentWeatherData.getInt("tomorrowPrecipitationChance", -1) + "%");
        }
        if (exceedsWindSpeedCondition) {
            dataWindSpeed.setText("Velocidad del viento: " + currentWeatherData.getInt("tomorrowWindSpeedMph", -1) + "mph");
        }
    }
